...
| 仓库 | 唯一职责 | 当前输出 |
|---|---|---|
| [ssice-a/EIEM](https://github.com/ssice-a/EIEM) | 游戏内 DLL、INI/Lua 运行时、EIEM 格式规范、跨端兼容测试 | DLL 发布包；读取 EIEMESH v2-v5 |
| [ssice-a/EIEM-blender](https://github.com/ssice-a/EIEM-blender) | Blender 导入、编辑、LOD/材质/切换作者数据和 Mod 导出 | EIEMESH v5 与 `mod.ini` |
...
3. 分别发布工具；最后更新 EIEM 中的 submodule 固定提交。
